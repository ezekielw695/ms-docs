...
public enum ExceptionEnum implements ErrorCode {
    ...
    MSDB_TEMPLATE_NAME_MISMATCH("2002"),

    // 4xx Client Error
    REQUEST_VALIDATION_ERROR("4001"),
    INVALID_JWT_EXCEPTION("4002"),

    // 5xx Server Error
    MSDB_PSQL_EXCEPTION("5001"),
    ...
    ExceptionEnum(String errorCode) {
        ...
        // 2xx Successful
        this.errorDescriptionMap.put("2001", MSDB_CASE_ID_NOT_FOUND_MSG);
        this.errorDescriptionMap.put("2002", MSDB_TEMPLATE_NAME_MISMATCH_MSG);

        // 4xx Client Error
        this.errorDescriptionMap.put("4001", REQUEST_VALIDATION_ERROR_MSG);
        this.errorDescriptionMap.put("4002", INVALID_JWT_EXCEPTION_MSG);

        // 5xx Server Error
        this.errorDescriptionMap.put("5001", MSDB_PSQL_EXCEPTION_MSG);
